...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonCalcula.setOnClickListener {
            ...
            Log.i("Salário", "xxxxx")
            Log.i("Salário", formatToDouble(editTextSalario.text.toString()).toString())
...
//        textViewSalarioLiquido.text = String.format("Salário Líquido: %s", f.format(liquido))
//        textViewImposto.text = String.format("Imposto: %s", f.format(imposto))
